...
class MySerializer
{
    ...
    public function singleObjectToArray(object $object, string $group='all'): array
    {
        ...
        $dateCallbackEndAndStart = function ($innerObject, $outerObject, string $attributeName, string $format = null, array $context = []) {
            return $innerObject instanceof \DateTime ? $innerObject->getTimestamp() : '';
        };
        ...
        $defaultContext = [
            AbstractNormalizer::CALLBACKS => [
                'date' => $dateCallback2,
                'startDate' => $dateCallbackEndAndStart,
                'shouldEndDate' => $dateCallbackEndAndStart,
                'backDate' => $dateCallback,
                'nextTime' => $dateCallbackEndAndStart,
                'lastDate' => $dateCallback,
