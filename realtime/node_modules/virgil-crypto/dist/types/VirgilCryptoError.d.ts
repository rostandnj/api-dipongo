export declare enum VirgilCryptoErrorStatus {
...
export declare class VirgilCryptoError extends Error {
    static readonly DEFAULT_MESSAGE = "Use the 'status' property and 'VirgilCryptoErrorStatus' enum to check for specific error.";
