...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'GENERATION_SAUVETEUR', 'description' => 'API', 'version' => '1.0.0'], 'securityDefinitions' => ['Bearer' => ['type' => 'apiKey', 'description' => 'Value: Bearer {jwt}', 'name' => 'Authorization', 'in' => 'header']], 'security' => [0 => ['Bearer' => []]]]);
    }
}
